 ...
 */
public class UndertowHandler_Old implements HttpHandler {
  private static final Logger LOG = LoggerFactory.getLogger(UndertowHandler_Old.class); // assuming a thread-safe backend
  ...
  public UndertowHandler_Old(@NotNull Service service, @NotNull TypesResolver typesResolver, long responseTimeout) {
  ...
  private void writeData(
    ...
    JsonFormatWriter fw = new JsonFormatWriter(stream);
  ...
  private void writeDatum(
    ...
    JsonFormatWriter fw = new JsonFormatWriter(outputStream);

...
/**
 * Checks for flag presence and reports as 'required not supported' if found
 *
 * @author <a href="mailto:konstantin.sobolev@gmail.com">Konstantin Sobolev</a>
 */
public class RequiredNotSupportedChecker extends OpProjectionTraversal {
  private final @NotNull PsiProcessingContext context;

  public RequiredNotSupportedChecker(final @NotNull PsiProcessingContext context) {this.context = context;}

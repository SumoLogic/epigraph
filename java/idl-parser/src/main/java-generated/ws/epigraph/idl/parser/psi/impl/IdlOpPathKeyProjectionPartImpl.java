...
public class IdlOpPathKeyProjectionPartImpl extends ASTWrapperPsiElement implements IdlOpPathKeyProjectionPart {

  public IdlOpPathKeyProjectionPartImpl(ASTNode node) {
    super(node);
  }

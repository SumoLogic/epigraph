...
public class IdlOpDeleteKeyProjectionPartImpl extends ASTWrapperPsiElement implements IdlOpDeleteKeyProjectionPart {

  public IdlOpDeleteKeyProjectionPartImpl(ASTNode node) {
    super(node);
  }

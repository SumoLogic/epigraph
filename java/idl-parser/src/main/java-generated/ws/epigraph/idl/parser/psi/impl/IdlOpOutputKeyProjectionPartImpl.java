...
public class IdlOpOutputKeyProjectionPartImpl extends ASTWrapperPsiElement implements IdlOpOutputKeyProjectionPart {

  public IdlOpOutputKeyProjectionPartImpl(ASTNode node) {
    super(node);
  }

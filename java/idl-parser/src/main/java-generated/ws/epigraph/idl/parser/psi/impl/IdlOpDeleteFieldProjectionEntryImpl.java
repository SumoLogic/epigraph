...
public class IdlOpDeleteFieldProjectionEntryImpl extends ASTWrapperPsiElement implements IdlOpDeleteFieldProjectionEntry {

  public IdlOpDeleteFieldProjectionEntryImpl(ASTNode node) {
    super(node);
  }

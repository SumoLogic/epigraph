...
public class IdlOpDeleteVarMultiTailItemImpl extends ASTWrapperPsiElement implements IdlOpDeleteVarMultiTailItem {

  public IdlOpDeleteVarMultiTailItemImpl(ASTNode node) {
    super(node);
  }

...
public class IdlOpDeleteModelPropertyImpl extends ASTWrapperPsiElement implements IdlOpDeleteModelProperty {

  public IdlOpDeleteModelPropertyImpl(ASTNode node) {
    super(node);
  }

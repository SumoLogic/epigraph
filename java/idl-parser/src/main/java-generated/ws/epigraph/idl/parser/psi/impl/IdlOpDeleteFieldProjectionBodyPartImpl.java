...
public class IdlOpDeleteFieldProjectionBodyPartImpl extends ASTWrapperPsiElement implements IdlOpDeleteFieldProjectionBodyPart {

  public IdlOpDeleteFieldProjectionBodyPartImpl(ASTNode node) {
    super(node);
  }

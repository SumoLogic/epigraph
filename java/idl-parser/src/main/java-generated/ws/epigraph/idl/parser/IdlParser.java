...
public class IdlParser implements PsiParser, LightPsiParser {
  ...
  public void parseLight(IElementType t, PsiBuilder b) {
    ...
    else if (t == I_OP_DELETE_FIELD_PROJECTION_ENTRY) {
    ...
    else if (t == I_OP_FIELD_PATH_ENTRY) {
    ...
    else if (t == I_OP_INPUT_FIELD_PROJECTION_ENTRY) {
    ...
    else if (t == I_OP_OUTPUT_FIELD_PROJECTION_ENTRY) {
  ...
  public static boolean anonList(PsiBuilder b, int l) {
    ...
    r = consumeTokens(b, 1, I_LIST, I_BRACKET_LEFT);
    p = r; // pin = 1
  ...
  public static boolean anonMap(PsiBuilder b, int l) {
    ...
    r = consumeTokens(b, 1, I_MAP, I_BRACKET_LEFT);
    p = r; // pin = 1
  ...
  public static boolean opDeleteFieldProjection(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, I_OP_DELETE_FIELD_PROJECTION, "<op delete field projection>");
  ...
  public static boolean opDeleteFieldProjectionEntry(PsiBuilder b, int l) {
    ...
    exit_section_(b, m, I_OP_DELETE_FIELD_PROJECTION_ENTRY, r);
    return r;
  }
  ...
  public static boolean opDeleteMultiTagProjection(PsiBuilder b, int l) {
    ...
    r = consumeTokens(b, 2, I_COLON, I_PAREN_LEFT);
    p = r; // pin = 2
  ...
  public static boolean opDeleteVarMultiTail(PsiBuilder b, int l) {
    ...
    r = consumeTokens(b, 2, I_TILDA, I_PAREN_LEFT);
    p = r; // pin = 2
  ...
  public static boolean opFieldPath(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, I_OP_FIELD_PATH, "<op field path>");
  ...
  public static boolean opFieldPathEntry(PsiBuilder b, int l) {
    ...
    exit_section_(b, m, I_OP_FIELD_PATH_ENTRY, r);
    return r;
  }
  ...
  public static boolean opInputDefaultValue(PsiBuilder b, int l) {
    ...
    r = consumeTokens(b, 1, I_DEFAULT, I_COLON);
    p = r; // pin = 1
    r = r && datum(b, l + 1);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  ...
  public static boolean opInputFieldProjectionBodyPart(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<op input field projection body part>", I_SEMICOLON, I_ID)) return false;
    boolean r;
  ...
  public static boolean opInputFieldProjectionEntry(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<op input field projection entry>", I_PLUS, I_ID)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, I_OP_INPUT_FIELD_PROJECTION_ENTRY, "<op input field projection entry>");
  ...
  public static boolean opInputModelMeta(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, I_META, I_COLON);
  ...
  public static boolean opOutputFieldProjectionEntry(PsiBuilder b, int l) {
    ...
    exit_section_(b, m, I_OP_OUTPUT_FIELD_PROJECTION_ENTRY, r);
    return r;
  }
  ...
  static boolean opParamBodyPart(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "", I_SEMICOLON, I_ID)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = opParam(b, l + 1);
    if (!r) r = annotation(b, l + 1);
  ...
  public static boolean operationDeleteProjection(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, I_OPERATION_DELETE_PROJECTION, null);
  ...
  public static boolean operationInputProjection(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, I_OPERATION_INPUT_PROJECTION, null);
  ...
  public static boolean operationInputType(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, I_OPERATION_INPUT_TYPE, null);
  ...
  public static boolean operationMethod(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, I_OPERATION_METHOD, null);
  ...
  public static boolean operationOutputProjection(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, I_OPERATION_OUTPUT_PROJECTION, null);
  ...
  public static boolean operationOutputType(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, I_OPERATION_OUTPUT_TYPE, null);

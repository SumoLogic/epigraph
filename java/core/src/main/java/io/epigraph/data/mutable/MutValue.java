...
public class MutValue extends ValueBase<MutValue> {

  public MutValue(@NotNull DatumType type) { super(type); }

  // TODO take different type as parameter?
  public static @NotNull MutValue from(@NotNull Value value) { // TODO move to parameterized static method in ValueBase

...
public class UrlReqOutputVarSingleTailImpl extends ASTWrapperPsiElement implements UrlReqOutputVarSingleTail {

  public UrlReqOutputVarSingleTailImpl(ASTNode node) {
    super(node);
  }

...
public class UrlReqUpdateFieldProjectionImpl extends ASTWrapperPsiElement implements UrlReqUpdateFieldProjection {

  public UrlReqUpdateFieldProjectionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UrlVisitor visitor) {
    visitor.visitReqUpdateFieldProjection(this);
  }

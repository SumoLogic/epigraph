...
public class UrlUrlImpl extends ASTWrapperPsiElement implements UrlUrl {

  public UrlUrlImpl(ASTNode node) {
    super(node);
  }
  ...
  public UrlReqTrunkFieldProjection getReqTrunkFieldProjection() {
    return findNotNullChildByClass(UrlReqTrunkFieldProjection.class);
  }

...
public class UrlReqOutputComaKeyProjectionImpl extends ASTWrapperPsiElement implements UrlReqOutputComaKeyProjection {

  public UrlReqOutputComaKeyProjectionImpl(ASTNode node) {
    super(node);
  }

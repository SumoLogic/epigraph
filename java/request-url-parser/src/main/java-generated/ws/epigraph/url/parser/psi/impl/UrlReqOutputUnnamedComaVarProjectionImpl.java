...
public class UrlReqOutputUnnamedComaVarProjectionImpl extends ASTWrapperPsiElement implements UrlReqOutputUnnamedComaVarProjection {

  public UrlReqOutputUnnamedComaVarProjectionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UrlVisitor visitor) {
    visitor.visitReqOutputUnnamedComaVarProjection(this);
  }
  ...
  @Override
  @Nullable
  public UrlReqOutputComaSingleTagProjection getReqOutputComaSingleTagProjection() {
    return findChildByClass(UrlReqOutputComaSingleTagProjection.class);
  }

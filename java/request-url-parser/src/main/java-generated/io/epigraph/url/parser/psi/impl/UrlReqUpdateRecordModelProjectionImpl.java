...
public class UrlReqUpdateRecordModelProjectionImpl extends ASTWrapperPsiElement implements UrlReqUpdateRecordModelProjection {
  ...
  @Override
  @NotNull
  public List<UrlReqUpdateFieldProjection> getReqUpdateFieldProjectionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, UrlReqUpdateFieldProjection.class);
  }

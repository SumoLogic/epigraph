...
public class SchemaOpOutputVarMultiTailItemImpl extends ASTWrapperPsiElement implements SchemaOpOutputVarMultiTailItem {

  public SchemaOpOutputVarMultiTailItemImpl(ASTNode node) {
    super(node);
  }

...
public class SchemaOpOutputRecordModelProjectionImpl extends ASTWrapperPsiElement implements SchemaOpOutputRecordModelProjection {
  ...
  @Override
  @NotNull
  public List<SchemaOpOutputFieldProjectionEntry> getOpOutputFieldProjectionEntryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SchemaOpOutputFieldProjectionEntry.class);
  }

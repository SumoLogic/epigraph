...
public class SchemaOpOutputVarSingleTailImpl extends ASTWrapperPsiElement implements SchemaOpOutputVarSingleTail {

  public SchemaOpOutputVarSingleTailImpl(ASTNode node) {
    super(node);
  }

...
import ws.epigraph.edl.parser.psi.stubs.SchemaEnumTypeDefStubElementType;
import ws.epigraph.edl.parser.psi.stubs.SchemaListTypeDefStubElementType;
import ws.epigraph.edl.parser.psi.stubs.SchemaMapTypeDefStubElementType;
import ws.epigraph.edl.parser.psi.stubs.SchemaNamespaceDeclStubElementType;
import ws.epigraph.edl.parser.psi.stubs.SchemaPrimitiveTypeDefStubElementType;
import ws.epigraph.edl.parser.psi.stubs.SchemaRecordTypeDefStubElementType;
import ws.epigraph.edl.parser.psi.stubs.SchemaSupplementDefStubElementType;
import ws.epigraph.edl.parser.psi.stubs.SchemaTypeDefWrapperStubElementType;
import ws.epigraph.edl.parser.psi.stubs.SchemaVarTypeDefStubElementType;
...
public interface SchemaElementTypes {
  ...
  IElementType S_CREATE = new SchemaElementType("CREATE");
  IElementType S_CURLY_LEFT = new SchemaElementType("{");
  IElementType S_CURLY_RIGHT = new SchemaElementType("}");
  IElementType S_CUSTOM = new SchemaElementType("CUSTOM");
  ...
  IElementType S_READ = new SchemaElementType("READ");
  ...
  IElementType S_UPDATE = new SchemaElementType("UPDATE");

...
public class SchemaOpInputVarSingleTailImpl extends ASTWrapperPsiElement implements SchemaOpInputVarSingleTail {

  public SchemaOpInputVarSingleTailImpl(ASTNode node) {
    super(node);
  }

...
public class SchemaOpOutputFieldProjectionBodyPartImpl extends ASTWrapperPsiElement implements SchemaOpOutputFieldProjectionBodyPart {

  public SchemaOpOutputFieldProjectionBodyPartImpl(ASTNode node) {
    super(node);
  }

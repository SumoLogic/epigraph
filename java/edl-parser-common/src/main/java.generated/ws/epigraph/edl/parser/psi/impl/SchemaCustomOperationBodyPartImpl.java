...
public class SchemaCustomOperationBodyPartImpl extends ASTWrapperPsiElement implements SchemaCustomOperationBodyPart {

  public SchemaCustomOperationBodyPartImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SchemaOperationMethod getOperationMethod() {
    return PsiTreeUtil.getChildOfType(this, SchemaOperationMethod.class);
  }

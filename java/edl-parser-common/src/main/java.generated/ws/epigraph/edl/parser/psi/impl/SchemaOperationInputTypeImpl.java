...
public class SchemaOperationInputTypeImpl extends ASTWrapperPsiElement implements SchemaOperationInputType {

  public SchemaOperationInputTypeImpl(ASTNode node) {
    super(node);
  }

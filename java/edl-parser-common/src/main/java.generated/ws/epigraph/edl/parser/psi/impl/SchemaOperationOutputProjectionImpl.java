...
public class SchemaOperationOutputProjectionImpl extends ASTWrapperPsiElement implements SchemaOperationOutputProjection {

  public SchemaOperationOutputProjectionImpl(ASTNode node) {
    super(node);
  }

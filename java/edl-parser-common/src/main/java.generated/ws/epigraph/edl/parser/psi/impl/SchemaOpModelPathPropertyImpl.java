...
public class SchemaOpModelPathPropertyImpl extends ASTWrapperPsiElement implements SchemaOpModelPathProperty {

  public SchemaOpModelPathPropertyImpl(ASTNode node) {
    super(node);
  }

...
public class EdlParser implements PsiParser, LightPsiParser {
  ...
  public static boolean createOperationDef(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, S_CREATE_OPERATION_DEF, "<create operation def>");
    r = createOperationDef_0(b, l + 1);
    r = r && consumeToken(b, S_CREATE);
    p = r; // pin = 2
  ...
  public static boolean customOperationDef(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<custom operation def>", S_DEFAULT, S_ID)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, S_CUSTOM_OPERATION_DEF, "<custom operation def>");
    r = operationName(b, l + 1);
    r = r && consumeToken(b, S_CUSTOM);
    p = r; // pin = 2
  ...
  public static boolean deleteOperationDef(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, S_DELETE_OPERATION_DEF, "<delete operation def>");
    r = deleteOperationDef_0(b, l + 1);
    r = r && consumeToken(b, S_DELETE);
    p = r; // pin = 2
  ...
  private static boolean operationBodyRecover_0_10_1(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, S_READ);
    if (!r) r = consumeToken(b, S_CREATE);
    if (!r) r = consumeToken(b, S_UPDATE);
    if (!r) r = consumeToken(b, S_DELETE);
    if (!r) r = consumeToken(b, S_CUSTOM);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  public static boolean operationDef(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, S_OPERATION_DEF, "<operation def>");
  ...
  public static boolean readOperationDef(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, S_READ_OPERATION_DEF, "<read operation def>");
    r = readOperationDef_0(b, l + 1);
    r = r && consumeToken(b, S_READ);
    p = r; // pin = 2
  ...
  public static boolean resourceDef(PsiBuilder b, int l) {
    ...
    exit_section_(b, m, S_RESOURCE_DEF, r);
    return r;
  }
  ...
  public static boolean updateOperationDef(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, S_UPDATE_OPERATION_DEF, "<update operation def>");
    r = updateOperationDef_0(b, l + 1);
    r = r && consumeToken(b, S_UPDATE);
    p = r; // pin = 2

...
public class SchemaOpDeleteVarMultiTailItemImpl extends ASTWrapperPsiElement implements SchemaOpDeleteVarMultiTailItem {

  public SchemaOpDeleteVarMultiTailItemImpl(ASTNode node) {
    super(node);
  }

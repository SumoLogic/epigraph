...
public class SchemaOpInputVarMultiTailItemImpl extends ASTWrapperPsiElement implements SchemaOpInputVarMultiTailItem {

  public SchemaOpInputVarMultiTailItemImpl(ASTNode node) {
    super(node);
  }

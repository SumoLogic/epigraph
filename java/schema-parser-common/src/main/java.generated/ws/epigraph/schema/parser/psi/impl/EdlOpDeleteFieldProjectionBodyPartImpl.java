...
public class EdlOpDeleteFieldProjectionBodyPartImpl extends ASTWrapperPsiElement implements EdlOpDeleteFieldProjectionBodyPart {

  public EdlOpDeleteFieldProjectionBodyPartImpl(ASTNode node) {
    super(node);
  }

...
public class EdlOpPathKeyProjectionPartImpl extends ASTWrapperPsiElement implements EdlOpPathKeyProjectionPart {

  public EdlOpPathKeyProjectionPartImpl(ASTNode node) {
    super(node);
  }

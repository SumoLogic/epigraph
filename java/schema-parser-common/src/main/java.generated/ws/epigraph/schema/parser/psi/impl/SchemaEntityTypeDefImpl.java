...
public class SchemaEntityTypeDefImpl extends SchemaEntityTypeDefImplBase implements SchemaEntityTypeDef {

  public SchemaEntityTypeDefImpl(ASTNode node) {
    super(node);
  }

  public SchemaEntityTypeDefImpl(SchemaEntityTypeDefStub stub, IStubElementType type) {
    super(stub, type);
  }

  public void accept(@NotNull SchemaVisitor visitor) {
    visitor.visitEntityTypeDef(this);
  }
  ...
  @Override
  @Nullable
  public SchemaEntityTypeBody getEntityTypeBody() {
    return PsiTreeUtil.getChildOfType(this, SchemaEntityTypeBody.class);
  }
  ...
  public PsiElement getEntity() {
    return notNullChild(findChildByType(S_ENTITY));
  }

...
public class EdlOpInputKeyProjectionPartImpl extends ASTWrapperPsiElement implements EdlOpInputKeyProjectionPart {

  public EdlOpInputKeyProjectionPartImpl(ASTNode node) {
    super(node);
  }

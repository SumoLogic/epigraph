...
public class SchemaUpdateOperationBodyPartImpl extends ASTWrapperPsiElement implements SchemaUpdateOperationBodyPart {

  public SchemaUpdateOperationBodyPartImpl(ASTNode node) {
    super(node);
  }

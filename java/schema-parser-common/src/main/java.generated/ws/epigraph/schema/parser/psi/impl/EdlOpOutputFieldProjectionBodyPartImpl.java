...
public class EdlOpOutputFieldProjectionBodyPartImpl extends ASTWrapperPsiElement implements EdlOpOutputFieldProjectionBodyPart {

  public EdlOpOutputFieldProjectionBodyPartImpl(ASTNode node) {
    super(node);
  }

...
public class EdlOpOutputKeyProjectionPartImpl extends ASTWrapperPsiElement implements EdlOpOutputKeyProjectionPart {

  public EdlOpOutputKeyProjectionPartImpl(ASTNode node) {
    super(node);
  }

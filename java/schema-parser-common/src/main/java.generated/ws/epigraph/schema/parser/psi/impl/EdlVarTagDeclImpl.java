...
public class EdlVarTagDeclImpl extends AnnotationsHolderImpl implements EdlVarTagDecl {

  public EdlVarTagDeclImpl(ASTNode node) {
    super(node);
  }
  ...
  public EdlVarTypeDef getVarTypeDef() {
    return EdlPsiImplUtil.getVarTypeDef(this);
  }

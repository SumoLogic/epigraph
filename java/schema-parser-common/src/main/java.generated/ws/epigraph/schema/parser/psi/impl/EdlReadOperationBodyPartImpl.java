...
public class EdlReadOperationBodyPartImpl extends ASTWrapperPsiElement implements EdlReadOperationBodyPart {

  public EdlReadOperationBodyPartImpl(ASTNode node) {
    super(node);
  }

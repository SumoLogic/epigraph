...
import ws.epigraph.schema.parser.psi.stubs.EdlEnumTypeDefStubElementType;
import ws.epigraph.schema.parser.psi.stubs.EdlListTypeDefStubElementType;
import ws.epigraph.schema.parser.psi.stubs.EdlMapTypeDefStubElementType;
import ws.epigraph.schema.parser.psi.stubs.EdlNamespaceDeclStubElementType;
import ws.epigraph.schema.parser.psi.stubs.EdlPrimitiveTypeDefStubElementType;
import ws.epigraph.schema.parser.psi.stubs.EdlRecordTypeDefStubElementType;
import ws.epigraph.schema.parser.psi.stubs.EdlSupplementDefStubElementType;
import ws.epigraph.schema.parser.psi.stubs.EdlTypeDefWrapperStubElementType;
import ws.epigraph.schema.parser.psi.stubs.EdlVarTypeDefStubElementType;
...
public interface EdlElementTypes {
  ...
  IElementType S_OP_CREATE = new EdlElementType("create");
  IElementType S_OP_CUSTOM = new EdlElementType("custom");
  IElementType S_OP_DELETE = new EdlElementType("delete");
  IElementType S_OP_READ = new EdlElementType("read");
  IElementType S_OP_UPDATE = new EdlElementType("update");

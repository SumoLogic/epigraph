...
public class EdlUpdateOperationBodyPartImpl extends ASTWrapperPsiElement implements EdlUpdateOperationBodyPart {

  public EdlUpdateOperationBodyPartImpl(ASTNode node) {
    super(node);
  }

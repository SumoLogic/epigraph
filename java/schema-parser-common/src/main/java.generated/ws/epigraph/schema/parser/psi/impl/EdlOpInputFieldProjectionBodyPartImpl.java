...
public class EdlOpInputFieldProjectionBodyPartImpl extends ASTWrapperPsiElement implements EdlOpInputFieldProjectionBodyPart {

  public EdlOpInputFieldProjectionBodyPartImpl(ASTNode node) {
    super(node);
  }

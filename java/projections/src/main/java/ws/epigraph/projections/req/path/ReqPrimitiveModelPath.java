...
public class ReqPrimitiveModelPath
    extends ReqModelPath<ReqModelPath<?, ?, ?>, ReqPrimitiveModelPath, PrimitiveTypeApi>
    implements GenPrimitiveModelProjection<ReqModelPath<?, ?, ?>, ReqPrimitiveModelPath, PrimitiveTypeApi> {

...
import com.sumologic.epigraph.schema.compiler.{CAnonMapType, CContext, CVarTypeDef}

class AnonMapGen(from: CAnonMapType, ctx: CContext) extends JavaTypeGen[CAnonMapType](from, ctx)

 ...
 */
class RecordBuilderGen(g: ReqOutputRecordModelProjectionGen, val ctx: GenContext) extends JavaGen {
...
/**
 * Value builder for {@code ${ln(cType)}} type, driven by request output projection
 */

 ...
 */
trait AbstractReqMapModelProjectionGen extends AbstractReqModelProjectionGen {
  ...
  def keyGen: AbstractReqMapKeyProjectionGen

  def elementGen: AbstractReqTypeProjectionGen

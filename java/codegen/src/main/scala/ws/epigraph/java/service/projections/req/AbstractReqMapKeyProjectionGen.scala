 ...
 */
trait AbstractReqMapKeyProjectionGen extends AbstractReqProjectionGen {
  ...
  protected def generate(reqKeyProjectionFqn: Qn, extra: CodeChunk = CodeChunk.empty): String = {
    val params = AbstractReqProjectionGen.generateParams(op.params(), namespace.toString, "raw.params()")

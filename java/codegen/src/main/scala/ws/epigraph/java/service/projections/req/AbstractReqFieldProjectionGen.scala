 ...
 */
trait AbstractReqFieldProjectionGen extends AbstractReqProjectionGen {
  type OpFieldProjectionType <: AbstractOpFieldProjection[_, _, _, _]

  protected def op: OpFieldProjectionType

  def dataProjectionGen: AbstractReqProjectionGen

  // -----

  override lazy val children: Iterable[AbstractReqProjectionGen] = Iterable(dataProjectionGen)
...
object AbstractReqFieldProjectionGen {

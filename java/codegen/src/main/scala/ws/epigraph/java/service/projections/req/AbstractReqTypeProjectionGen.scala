 ...
 */
trait AbstractReqTypeProjectionGen extends AbstractReqProjectionGen {
  type OpProjectionType <: GenProjectionReference[_]

  def op: OpProjectionType

  protected def generatedProjections: java.util.Map[ProjectionReferenceName, AbstractReqTypeProjectionGen]
...
object AbstractReqTypeProjectionGen {

...
import ws.epigraph.services.resources.epigraph.operations.read.types.AbstractReadTypesOperation;
import ws.epigraph.services.resources.epigraph.operations.read.types.output.OutputEpigraphFieldProjection;
import ws.epigraph.services.resources.epigraph.operations.read.types.output.OutputNameString_Type_MapKeyProjection;
import ws.epigraph.services.resources.epigraph.operations.read.types.output.OutputNameString_Type_MapProjection;
import ws.epigraph.services.resources.epigraph.operations.read.types.path.EpigraphFieldPath;

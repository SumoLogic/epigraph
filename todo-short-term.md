...
- [x] `UriComposer`: make sure `+` is added before flagged delete entity projections (+UT)
...
- [x] codegen: Map.put with primitive keys: understand java primitives ~~+ `setTag` for primitive tags~~

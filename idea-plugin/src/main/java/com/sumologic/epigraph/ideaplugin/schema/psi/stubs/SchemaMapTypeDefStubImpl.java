...
public class SchemaMapTypeDefStubImpl extends SchemaTypeDefStubBaseImpl<SchemaMapTypeDef> implements SchemaMapTypeDefStub {
  SchemaMapTypeDefStubImpl(StubElement parent, String name, String namespace) {
    super(parent, (IStubElementType) SchemaElementTypes.S_MAP_TYPE_DEF, name, namespace);
  }
}

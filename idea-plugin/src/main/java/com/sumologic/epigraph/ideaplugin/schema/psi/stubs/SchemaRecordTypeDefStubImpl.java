...
public class SchemaRecordTypeDefStubImpl extends SchemaTypeDefStubBaseImpl<SchemaRecordTypeDef> implements SchemaRecordTypeDefStub {
  SchemaRecordTypeDefStubImpl(StubElement parent, String name, String namespace) {
    super(parent, (IStubElementType) SchemaElementTypes.S_RECORD_TYPE_DEF, name, namespace);
  }
}

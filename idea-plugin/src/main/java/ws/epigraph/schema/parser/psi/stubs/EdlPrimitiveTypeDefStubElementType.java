...
import ws.epigraph.schema.parser.psi.impl.EdlPrimitiveTypeDefImpl;
...
public class EdlPrimitiveTypeDefStubElementType extends EdlTypeDefStubElementTypeBase<EdlPrimitiveTypeDefStub, EdlPrimitiveTypeDef> {
  ...
  public EdlPrimitiveTypeDefStub createStub(@NotNull EdlPrimitiveTypeDef typeDef, StubElement parentStub) {
    return new EdlPrimitiveTypeDefStubImpl(
        parentStub,
        typeDef.getName(),
  ...
  @NotNull
  @Override
  protected EdlPrimitiveTypeDefStub deserialize(
      @NotNull StubInputStream dataStream,
      StubElement parentStub,
      String name, String namespace,
      @Nullable final List<SerializedFqnTypeRef> extendsTypeRefs) throws IOException {
    return new EdlPrimitiveTypeDefStubImpl(parentStub, name, namespace, extendsTypeRefs);
  }
}

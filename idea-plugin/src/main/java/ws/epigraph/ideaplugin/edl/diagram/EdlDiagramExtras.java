 ...
 */
public class EdlDiagramExtras extends DiagramExtras<PsiNamedElement> {
  private static final DiagramDefaultAddElementAction<PsiNamedElement> ADD_ELEMENT_ACTION =
      new EdlDiagramAddElementAction();

  @SuppressWarnings("unchecked")
  private static final DiagramElementsProvider<PsiNamedElement>[] ELEMENTS_PROVIDERS = new DiagramElementsProvider[]{
      new EdlDiagramParentElementsProvider(), new EdlDiagramImplementationElementsProvider()
  };

  private static final DiagramDnDProvider<PsiNamedElement> DND_PROVIDER = new EdlDiagramDnDProvider();

 ...
 */
public class ExtendsBlock extends SchemaBlock {
  public ExtendsBlock(@NotNull ASTNode node, @Nullable Wrap wrap, @Nullable Alignment alignment, @Nullable Indent indent, SpacingBuilder spacingBuilder) {

 ...
 */
public class EdlDiagramParentElementsProvider extends SupersProvider<PsiNamedElement> {
  @Override
  ...
  public PsiNamedElement[] getElements(PsiNamedElement psiNamedElement, Project project) {
    ...
    List<EdlTypeDef> parents = HierarchyCache.getHierarchyCache(project).getDirectTypeParents(typeDef);
  ...
  public String getHeaderName(PsiNamedElement psiNamedElement, Project project) {
    return EdlBundle.message("diagram.show.supertypes", psiNamedElement.getName());
  }

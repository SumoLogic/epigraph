 ...
 */
public class EdlLineMover extends LineMover {
  @Override
  public boolean checkAvailable(@NotNull Editor editor, @NotNull PsiFile file, @NotNull MoveInfo info, boolean down) {
    if (!(file instanceof EdlFile) || !super.checkAvailable(editor, file, info, down)) return false;
    ...
    Class<? extends PsiNamedElement> movedClass = moved instanceof EdlTypeDef ? EdlTypeDef.class : moved.getClass();
    ...
    if (down) {
      ...
      if (updatedElement != null) {
        ...
        final PsiElement target = EdlPsiUtil.getElementOrParentOfType(updatedElement, movedClass, PsiComment.class);
...
//            info.prohibitMove(); // disallows moving members between types
      ...
      if (updatedElement != null) {
        ...
        if (target == null) {
          if (moved instanceof EdlTypeDef)
            info.prohibitMove();
          return true;
        }

 ...
 */
public class RetroDeclBlock extends SchemaBlock {
  public RetroDeclBlock(@NotNull ASTNode node, @Nullable Wrap wrap, @Nullable Alignment alignment, @Nullable Indent indent, SpacingBuilder spacingBuilder) {

...
public class CreateEdlFileAction extends CreateFileFromTemplateAction implements DumbAware {
  public static final String NEW_EDL_FILE = "New Epigraph Schema File";
  ...
  protected void buildDialog(Project project, PsiDirectory directory, CreateFileFromTemplateDialog.Builder builder) {
    builder.setTitle(NEW_EDL_FILE)
        .addKind("Empty Schema", EdlPresentationUtil.edlFileIcon(), "Epigraph Schema." + Common.FILE_EXTENSION)

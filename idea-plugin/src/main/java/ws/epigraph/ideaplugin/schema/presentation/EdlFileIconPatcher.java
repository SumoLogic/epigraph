...
import ws.epigraph.ideaplugin.schema.index.EdlFileIndexUtil;
 ...
 */
public class EdlFileIconPatcher implements FileIconPatcher {
  @Override
  ...
  private static Icon replaceIcon(VirtualFile file, @Iconable.IconFlags int flags, Project project, Icon baseIcon) {
    ...
    if (fileType == EdlFileType.INSTANCE && !EdlFileIndexUtil.isEdlSourceFile(project, file)) {
      return EdlPresentationUtil.edlOutsideSourceFileIcon();
    }

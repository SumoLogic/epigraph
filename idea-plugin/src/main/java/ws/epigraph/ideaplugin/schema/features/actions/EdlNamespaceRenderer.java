 ...
 */
public class EdlNamespaceRenderer extends ColoredListCellRenderer {
  public static EdlNamespaceRenderer INSTANCE = new EdlNamespaceRenderer();

  public EdlNamespaceRenderer() {

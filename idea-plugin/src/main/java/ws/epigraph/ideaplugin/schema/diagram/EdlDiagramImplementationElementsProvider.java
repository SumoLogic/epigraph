 ...
 */
public class EdlDiagramImplementationElementsProvider extends ImplementationsProvider<PsiNamedElement> {
  @Override
  ...
  public PsiNamedElement[] getElements(PsiNamedElement psiNamedElement, Project project) {
    EdlTypeDef typeDef = (EdlTypeDef) psiNamedElement;
    List<EdlTypeDef> parents = HierarchyCache.getHierarchyCache(project).getDirectTypeInheritors(typeDef);
  ...
  public String getHeaderName(PsiNamedElement psiNamedElement, Project project) {
    return EdlBundle.message("diagram.show.subtypes", psiNamedElement.getName());
  }

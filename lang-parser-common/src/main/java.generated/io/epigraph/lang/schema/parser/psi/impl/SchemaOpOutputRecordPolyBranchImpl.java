...
public class SchemaOpOutputRecordPolyBranchImpl extends ASTWrapperPsiElement implements SchemaOpOutputRecordPolyBranch {

  public SchemaOpOutputRecordPolyBranchImpl(ASTNode node) {
    super(node);
  }
  ...
  public SchemaOpOutputRecordModelProjection getOpOutputRecordModelProjection() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, SchemaOpOutputRecordModelProjection.class));
  }

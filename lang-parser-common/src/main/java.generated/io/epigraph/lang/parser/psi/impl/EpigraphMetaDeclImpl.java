...
public class EpigraphMetaDeclImpl extends ASTWrapperPsiElement implements EpigraphMetaDecl {

  public EpigraphMetaDeclImpl(ASTNode node) {
    super(node);
  }
  ...
  public EpigraphFqnTypeRef getFqnTypeRef() {
    return PsiTreeUtil.getChildOfType(this, EpigraphFqnTypeRef.class);
  }

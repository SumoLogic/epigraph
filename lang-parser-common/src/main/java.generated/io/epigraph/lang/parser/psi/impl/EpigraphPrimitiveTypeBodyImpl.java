...
public class EpigraphPrimitiveTypeBodyImpl extends CustomParamHolderImpl implements EpigraphPrimitiveTypeBody {

  public EpigraphPrimitiveTypeBodyImpl(ASTNode node) {
    super(node);
  }

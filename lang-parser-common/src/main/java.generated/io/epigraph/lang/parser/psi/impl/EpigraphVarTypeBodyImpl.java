...
public class EpigraphVarTypeBodyImpl extends CustomParamHolderImpl implements EpigraphVarTypeBody {

  public EpigraphVarTypeBodyImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EpigraphVarTagDecl> getVarTagDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EpigraphVarTagDecl.class);
  }

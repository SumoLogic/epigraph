...
public class EpigraphImportStatementImpl extends ASTWrapperPsiElement implements EpigraphImportStatement {

  public EpigraphImportStatementImpl(ASTNode node) {
    super(node);
  }

...
public class EpigraphRecordTypeBodyImpl extends CustomParamHolderImpl implements EpigraphRecordTypeBody {

  public EpigraphRecordTypeBodyImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EpigraphFieldDecl> getFieldDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EpigraphFieldDecl.class);
  }

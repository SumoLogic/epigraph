...
public class EpigraphSupplementsDeclImpl extends ASTWrapperPsiElement implements EpigraphSupplementsDecl {

  public EpigraphSupplementsDeclImpl(ASTNode node) {
    super(node);
  }

...
public class EpigraphEnumTypeBodyImpl extends CustomParamHolderImpl implements EpigraphEnumTypeBody {

  public EpigraphEnumTypeBodyImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EpigraphEnumMemberDecl> getEnumMemberDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EpigraphEnumMemberDecl.class);
  }

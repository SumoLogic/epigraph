...
public class IdlReqOutputVarSingleTailImpl extends ASTWrapperPsiElement implements IdlReqOutputVarSingleTail {

  public IdlReqOutputVarSingleTailImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitReqOutputVarSingleTail(this);
  }
